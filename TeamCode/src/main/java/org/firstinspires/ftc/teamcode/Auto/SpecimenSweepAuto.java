...
public class SpecimenSweepAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action runAuto = drive.actionBuilder(new Pose2d(-24, 64, Math.toRadians(-90)))
                ...
                .splineToLinearHeading(new Pose2d(-44,64,Math.toRadians(140)),Math.toRadians(75), drive.defaultVelConstraint, new ProfileAccelConstraint(-50,60))
                .stopAndAdd(bot.armUp())
                .afterTime(0.9,bot.actionSweep())
                .strafeToLinearHeading(new Vector2d(-50,34),Math.toRadians(-120))
                .afterTime(0.1, bot.autoSpecimen())
                .strafeToLinearHeading(new Vector2d(-53,62),Math.toRadians(140), drive.defaultVelConstraint, new ProfileAccelConstraint(-50,60))
