...
//heading, tangent
        Action runAuto = drive.actionBuilder(new Pose2d(-24, 64, Math.toRadians(-90)))
                ...
                //clip preload
                .afterTime(0.7,bot.actionSweep())
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(-40, 39,Math.toRadians(-120)),Math.toRadians(105), drive.defaultVelConstraint, new ProfileAccelConstraint(-52,85))
                .splineToLinearHeading(new Pose2d(-42,64,Math.toRadians(140)),Math.toRadians(75), drive.defaultVelConstraint, new ProfileAccelConstraint(-52,85))
                ...
                .stopAndAdd(bot.actionHighChamberAuto())
                .setReversed(false)
                .splineToConstantHeading(new Vector2d(2.5,30.5),Math.toRadians(140), drive.defaultVelConstraint, new ProfileAccelConstraint(-50,90))
                .stopAndAdd(bot.actionAutoClip())
                ...
                .stopAndAdd(bot.actionHighChamberAuto())
                .setReversed(false)
                .splineToConstantHeading(new Vector2d(0,30.5),Math.toRadians(140), drive.defaultVelConstraint, new ProfileAccelConstraint(-55,95))
                .stopAndAdd(bot.actionAutoClip())
                .stopAndAdd(bot.actionSlidesLower())
                .waitSeconds(0.25)
                ...
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(-38, 67), Math.toRadians(80), drive.defaultVelConstraint, new ProfileAccelConstraint(-55,90))
                .stopAndAdd(bot.autoIntakeSpecimen())
                .stopAndAdd(bot.actionHighChamberAuto())
                .setReversed(false)
                .splineToConstantHeading(new Vector2d(-2,30.5),Math.toRadians(140), drive.defaultVelConstraint, new ProfileAccelConstraint(-55,90))
                .stopAndAdd(bot.actionAutoClip())
                .stopAndAdd(bot.actionSlidesLower())
                //fourth specimen
                ...
                .stopAndAdd(bot.actionHighChamberAuto())
                .setReversed(false)
                .splineToConstantHeading(new Vector2d(-4,30.5),Math.toRadians(140), drive.defaultVelConstraint, new ProfileAccelConstraint(-55,90 ))
                .stopAndAdd(bot.actionAutoClip())
                .stopAndAdd(bot.actionSlidesLower())
