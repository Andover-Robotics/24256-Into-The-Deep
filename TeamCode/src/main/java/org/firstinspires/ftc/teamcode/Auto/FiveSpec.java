...
//heading, tangent
        Action runAuto = drive.actionBuilder(new Pose2d(-10, 64, Math.toRadians(-90)))
                ...
                .afterTime(0.4, bot.actionHighChamberAuto())
                .stopAndAdd(bot.autoIntakeSpecimen())
                .afterTime(1.8, bot.actionAutoClip())
                .setReversed(false)
                .splineToLinearHeading(new Pose2d(0,30.5, Math.toRadians(-90)), Math.toRadians(180), drive.defaultVelConstraint, new ProfileAccelConstraint(-50,90))
                .waitSeconds(0.3)
                //second specimen
                ...
                .splineToConstantHeading(new Vector2d(0, 30.5),Math.toRadians(130), drive.defaultVelConstraint, new ProfileAccelConstraint(-55,95))
                .waitSeconds(0.4)
                //third specimen
                ...
                .splineToLinearHeading(new Pose2d(-4.5, 29, Math.toRadians(-90)), Math.toRadians(-90), drive.defaultVelConstraint, new ProfileAccelConstraint(-55,92))
                .waitSeconds(0.4)
                ...
                .splineToLinearHeading(new Pose2d(-7.5, 29.5, Math.toRadians(-90)), Math.toRadians(-90), drive.defaultVelConstraint, new ProfileAccelConstraint(-55,92))
