        ...
        while (opModeIsActive()) {
            ...
            if (gp2.wasJustPressed(GamepadKeys.Button.DPAD_RIGHT)) {
                ...
                Action runAuto = drive.actionBuilder(new Pose2d(-60, 64, Math.toRadians(-90)))
                        ...
                        .strafeToConstantHeading(new com.acmerobotics.roadrunner.Vector2d(-38,60))
                        .strafeToConstantHeading(new com.acmerobotics.roadrunner.Vector2d(-40,67.5))
                        ...
                        .stopAndAdd(bot.actionHighChamberAuto())
                        .strafeToConstantHeading(new com.acmerobotics.roadrunner.Vector2d(-1.5,45),drive.defaultVelConstraint, new ProfileAccelConstraint(-35,80))
                        .splineToConstantHeading(new com.acmerobotics.roadrunner.Vector2d(-1.5,30.5),Math.toRadians(90), drive.defaultVelConstraint, new ProfileAccelConstraint(-35,80))
                        .stopAndAdd(bot.actionAutoClip())
                        .stopAndAdd(bot.actionSlidesLower())
                        .waitSeconds(0.25)
