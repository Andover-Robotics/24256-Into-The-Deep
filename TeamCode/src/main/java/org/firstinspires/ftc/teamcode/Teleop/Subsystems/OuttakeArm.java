...
public class OuttakeArm {
    ...
    public static final double transfer = .205;
    public static final double outtake = .68;
    public static final double vertical = .475;
    public static final double wallIntake = .86;
