...
public class OuttakeArm {
    ...
    public static final double transfer = .16;
    public static final double outtake = .635;
    public static final double vertical = .46;
    public static final double wallIntake = .87;
