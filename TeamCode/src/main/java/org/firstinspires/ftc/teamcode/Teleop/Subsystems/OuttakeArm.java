...
public class OuttakeArm {
    ...
    public static final double transfer = .24;
    public static final double outtake = .67;
    public static final double vertical = .492;
    public static final double wallIntake = .95;
